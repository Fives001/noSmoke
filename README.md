...
- **계급(진급) 시스템**: 금연 기간에 따라 훈련병 → 원수까지 20계급. 홈 화면에 현재 계급장·다음 진급까지
  남은 시간을 표시하고, 「계급」 탭에서 계급별 조건과 설명을 확인합니다. 진급 시 알림/진동으로 알려줍니다.
  - 병사(1일·3일·1주·2주) → 부사관(4·6·8·10주) → 위관(12·16·20주) → 영관(6개월·9개월·1년) → 장성(1.5년~10년)
  - 계급장은 외부 이미지 없이 SVG로 그립니다(작대기·갈매기·다이아·무궁화·별)
